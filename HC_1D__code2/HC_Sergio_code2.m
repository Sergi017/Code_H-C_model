...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%import of 10 simulations with different porosity exponent: 
load('Dehy_front1_S2','Dehy_front')
Dehy_front1=Dehy_front;
load('Dehy_front2_S2','Dehy_front')
Dehy_front2=Dehy_front;
load('Dehy_front3_S2','Dehy_front')
Dehy_front3=Dehy_front;
load('Dehy_front4_S2','Dehy_front')
Dehy_front4=Dehy_front;
load('Dehy_front5_S2','Dehy_front')
Dehy_front5=Dehy_front;
load('Dehy_front6_S2','Dehy_front')
Dehy_front6=Dehy_front;
load('Dehy_front7_S2','Dehy_front')
Dehy_front7=Dehy_front;
load('Dehy_front8_S2','Dehy_front')
Dehy_front8=Dehy_front;
load('Dehy_front9_S2','Dehy_front')
Dehy_front9=Dehy_front;
load('Dehy_front10_S2','Dehy_front')
Dehy_front10=Dehy_front;

load('t_vein1_S2','t_vein')
t_vein1=t_vein;
load('t_vein2_S2','t_vein')
t_vein2=t_vein;
load('t_vein3_S2','t_vein')
t_vein3=t_vein;
load('t_vein4_S2','t_vein')
t_vein4=t_vein;
load('t_vein5_S2','t_vein')
t_vein5=t_vein;
load('t_vein6_S2','t_vein')
t_vein6=t_vein;
load('t_vein7_S2','t_vein')
t_vein7=t_vein;
load('t_vein8_S2','t_vein')
t_vein8=t_vein;
load('t_vein9_S2','t_vein')
t_vein9=t_vein;
load('t_vein10_S2','t_vein')
t_vein10=t_vein;

load('error_Dehy_front_nx100','Dehy_front')
Dehy_front100=Dehy_front;
load('error_Dehy_front_nx400','Dehy_front')
Dehy_front400=Dehy_front;
load('error_Dehy_front_nx600','Dehy_front')
Dehy_front600=Dehy_front;
load('error_Dehy_front_nx800','Dehy_front')
Dehy_front800=Dehy_front;
